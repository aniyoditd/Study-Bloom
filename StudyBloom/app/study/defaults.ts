...
export const DEFAULT_STATE: StudyState = {
  ...
  classes: [
    { id: "bio-101", name: "General Biology", subject: "Science", code: "BIO 101", instructor: "Dr. Rivera", color: "#7b5ccc", icon: "🧬", term: "Fall 2026" },
    { id: "hist-204", name: "Modern World History", subject: "History", code: "HIST 204", instructor: "Prof. Chen", color: "#d88760", icon: "🏛️", term: "Fall 2026" },
    { id: "math-121", name: "Calculus I", subject: "Math", code: "MATH 121", instructor: "Dr. Patel", color: "#4d83be", icon: "∑", term: "Fall 2026" },
  ],
  materials: [
    {
